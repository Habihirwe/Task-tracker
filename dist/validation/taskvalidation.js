...
var taskValidationSChema = _joi["default"].object({
  ...
  starteddate: _joi["default"].string().required().label("startingtime").messages({
    "any.required": "The  description field can not be empty"
  }),
  priority: _joi["default"].string().required().label("priority").messages({
    "any.required": "The  description field can not be empty"
  })
});
var _default = exports["default"] = taskValidationSChema;